...
func NewSystemHexagon(system *structs.System, q int, r int, s int) SystemHexagon {
    ...
    // Set the custom render function
    systemHex.Hexagon.RenderFunc = systemHex.render
    return systemHex
}

// render is now a private method that will be called through the RenderFunc field
